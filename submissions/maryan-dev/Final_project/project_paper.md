...
### 2.2 Preprocessing pipeline (code)
...
### 4.3 Sanity checks (best model / API)
...
### 5.2 Frontend (optional / extra credit)
...
**Word count note:** Export this file to PDF if the portal requires PDF; content is structured for 3–5 printed pages with normal formatting.
